...
function scanRepo(dir, pretty) {
  const label = path.basename(dir);
  const project = { key: label, label: prettyName(label, pretty), path: tildify(dir), dir, warnings: [] };
...
function scan({ root, sessionDir, defaultProject, pretty }) {
