...
/* Clicking a session is the hyperlink Saul asked for: switch project if needed,
   then highlight that branch. */
...
const paneDefaults = {side:322, adv:null};
let panes = (() => {
...
function applyPanes(){
  ...
  if(panes.adv){
    ...
    root.style.removeProperty("--advmax");
  }
}
